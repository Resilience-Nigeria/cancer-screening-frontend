  ...
  return (
    <div className="rounded-3xl border border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm p-5">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        ...
        <Link href={`/ncsr/visits?visitId=${visit.visitId}`}>
...
export default function ClientProfilePage() {
  ...
  try {
    ...
    // Check if risk profile exists by verifying it has an ID
          ...
          <div className="px-5 py-6 sm:px-8 sm:py-8 text-white">
            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                <Link href={`/ncsr/new-visit?clientId=${client.clientId}`}>
                  <Button className="rounded-2xl h-11  text-green-800 border-white hover:bg-green-50">
                ...
                <Link href={`/ncsr/risk-profile?clientId=${client.clientId}`}>
                  <Button
                    layout="outline"
                ...
                <Link href={`/ncsr/outcome?clientId=${client.clientId}`}>
                  <Button
                    layout="outline"
                    className="rounded-2xl h-11 border-white text-white hover:bg-white/10"
                  >
        ...
        <div className="grid gap-4">
          {client.visits && client.visits.length > 0 ? (
            ...
            <div className="rounded-3xl border border-dashed border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-8 text-center">
              ...
              <div className="mt-5">
                <Link href={`/ncsr/new-visit?clientId=${client.clientId}`}>
                  <Button className="rounded-2xl bg-green-700 border-green-700 hover:bg-green-800 hover:border-green-800">
                    <span className="inline-flex items-center gap-2">
                      <Plus className="w-4 h-4" />
                      New Visit
                    </span>
